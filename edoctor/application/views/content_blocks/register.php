                        ...
                        <div class="mx-auto app-login-box col-md-8">
                            ...
                            <div class="modal-dialog w-100 mx-auto">
                                <div class="modal-content">
                                    <form action="<?php echo site_url(); ?>/login/registersave" method="post" >
                                        <div class="modal-body">
                                            <div class="h5 modal-title text-center">
                                                <img src="<?php echo base_url() ?>assets/images/logo-inverse.png" style="width: 40%" class="img img-fluid" />
                                                <br>
                                            </div>
                                            <br>
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group"><input name="contact" id="name" placeholder="Contact" required="required" type="text" class="form-control" /></div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group"><input name="username" id="username" placeholder="Username or Email" required="required" type="text" class="form-control"></div>
                                                </div>
                                                <div class="col-md-12">
