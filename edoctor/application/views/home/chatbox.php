...
<div class="app-main__outer">
    ...
    <form action="<?php echo site_url(); ?>/myrequests/savePatientChat" method="post">
        <div class="container-fluid">
            <textarea class="form-control" name="message" id="" cols="30" rows="10" placeholder="write message"></textarea>
