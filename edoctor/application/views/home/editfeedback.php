    ...
    <form action="<?php echo site_url(); ?>/feedback/saveFeedback" method="POST">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <textarea class="card-text" rows="10" name="feedback" id="feedback"  cols="150"></textarea><br><br>
            </div>
...
<script>
    ...
    var feedback = '<?php echo $feedback_details['review'] ?>';
    $('#feedback').html(feedback);

    var rating = '<?php echo $feedback_details['rating'] ?>';

    $("input[name=rate][value='" + rating + "']").prop('checked', 'checked');
</script>
